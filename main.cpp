...
NAN_METHOD(Hello) {
    ...
    // 'info' is a macro's "implicit" parameter - it's a bridge object between C++ and 
    // JavaScript runtimes.
    // You would use info to both extract the parameters passed to a function as well as
